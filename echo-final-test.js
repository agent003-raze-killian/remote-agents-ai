...
async function checkAndReply() {
  try {
    ...
    // Try different channel formats - including common channel IDs
    const channelFormats = [
      'general',
      '#general', 
      'C073JQZQZ', // Common general channel ID format
      'C09MF7PLEKV', // Based on team ID
      'C09NN89D6KA'  // Based on bot user ID
    ];
...
async function startEcho() {
  console.log('🚀 Starting Echo Channel Finder...');
