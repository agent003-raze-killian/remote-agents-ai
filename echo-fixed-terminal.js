...
async function findWorkingChannel() {
  ...
  console.log('❌ No working channel found. Please add groups:read scope to your Slack app.');
  return null;
}
...
async function startEcho() {
  ...
  if (!channel) {
    ...
    console.log('🔧 Please add groups:read scope to your Slack app and reinstall.');
    return;
  }
